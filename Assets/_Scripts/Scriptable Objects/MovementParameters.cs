...
public class MovementParameters : ScriptableObject
{
    ...
    [Range(0.25f, 50f)] public float WallJumpMoveDeceleratoin = 5f;
    ...
    [Header("Wall Slide")]
    [Min(0.01f)] public float WallSlideSpped = 5f;
    ...
    public bool TurnToWallJumpDirection = true;

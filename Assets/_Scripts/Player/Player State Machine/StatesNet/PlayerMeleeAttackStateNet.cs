...
public class PlayerMeleeAttackStateNet : PlayerStateNet
{
    public PlayerMeleeAttackStateNet(PlayerNet player, PlayerStateMachineNet stateMachine) : base(player, stateMachine)
    {
    }

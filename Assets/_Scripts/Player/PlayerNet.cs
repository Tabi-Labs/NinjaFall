...
public class PlayerNet : NetworkBehaviour
{
    ...
    //state vars
    public PlayerStateMachineNet StateMachine { get; private set; }
    public PlayerIdleStateNet IdleState { get; private set; }
    public PlayerWalkStateNet WalkState { get; private set; }
    public PlayerRunStateNet RunState { get; private set; }
    public PlayerJumpStateNet JumpState { get; private set; }
    public PlayerInAirStateNet InAirState { get; private set; }
    public PlayerWallSlideStateNet WallSlideState { get; private set; }
    ...
    public override void OnNetworkSpawn()
    {
        ...
        IdleState = new PlayerIdleStateNet(this, StateMachine);
        WalkState = new PlayerWalkStateNet(this, StateMachine);
        RunState = new PlayerRunStateNet(this, StateMachine);
        JumpState = new PlayerJumpStateNet(this, StateMachine);
        InAirState = new PlayerInAirStateNet(this, StateMachine);

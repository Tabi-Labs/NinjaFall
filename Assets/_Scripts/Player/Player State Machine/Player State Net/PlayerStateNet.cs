...
public class PlayerStateNet
{
    protected PlayerNet _player;
    protected PlayerStateMachineNet _playerStateMachine;

    protected PlayerMovementStats _moveStats;

    protected bool _isExitingState;

    public PlayerStateNet(PlayerNet player, PlayerStateMachineNet stateMachine)
    {
        _player = player;
